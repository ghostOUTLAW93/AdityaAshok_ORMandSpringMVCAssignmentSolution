				...
				<c:forEach items="${customers}" var="customer">
					<tr>
						...
						<td>
							...
							href="/CustomerRelationshipManagement/customers/update?customerId=${customer.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a
							href="/CustomerRelationshipManagement/customers/delete?customerId=${customer.id}"
